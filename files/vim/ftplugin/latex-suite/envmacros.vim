...
let s:table =      "\\begin{table}\<cr>\\caption{<+Caption text+>}\<cr>\\vspace{3mm}<cr>\\label{tab:<+label+>}\<cr>\\centering\<cr>\\begin{tabular}{<+dimensions+>}\<cr><++>\<cr>\\end{tabular}\<cr>\\end{table}<++>"
